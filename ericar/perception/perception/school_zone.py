...
class SchoolZoneDetector:
    ...
    def __init__(self, logger=None, debug=False, show=False,
                 ...
                 white_exit=WHITE_EXIT, white_normal=WHITE_NORMAL):
        self.logger = logger
        self.debug = debug
        self.show = show
        ...
        self.white_normal = white_normal
    ...
    def draw(self, image):
        """하단 ROI 경계 + 현재 신호(0/1/2)를 full-image 위에 그린다 (통합 창용)."""
        h, w = image.shape[:2]
        y0 = int(h * self.roi_top)
